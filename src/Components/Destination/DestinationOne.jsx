...
const destinations = [
  { id: 1, name: "ඉන්දියාව (දඹදිව)", listings: 15, image: "/assets/img/destination/destination_1_1.jpg" },
  { id: 2, name: "තායිලන්තය", listings: 22, image: "/assets/img/destination/destination_1_2.jpg" },
  { id: 3, name: "ශ්‍රී ලංකාව", listings: 25, image: "/assets/img/destination/destination_1_3.jpg" },
  { id: 4, name: "බැංකොක්", listings: 28, image: "/assets/img/destination/destination_1_4.jpg" },
  { id: 5, name: "නේපාලය", listings: 30, image: "/assets/img/destination/destination_1_5.jpg" },
  { id: 6, name: "ඉන්දියාව (දඹදිව)", listings: 15, image: "/assets/img/destination/destination_1_1.jpg" },
  { id: 7, name: "තායිලන්තය", listings: 22, image: "/assets/img/destination/destination_1_2.jpg" },
  { id: 8, name: "ශ්‍රී ලංකාව", listings: 25, image: "/assets/img/destination/destination_1_3.jpg" },
  { id: 9, name: "බැංකොක්", listings: 28, image: "/assets/img/destination/destination_1_4.jpg" },
  { id: 10, name: "නේපාලය", listings: 30, image: "/assets/img/destination/destination_1_5.jpg" },
];
