        ...
        <div className="hero-3" id="hero">
            ...
            >
                ...
                {[
                    ...
                    { img: "/assets/img/hero/hero_bg_3_4.jpg", title: "Explore with BSTours.lk" },
                ].map((slide, index) => (
                            ...
                            <div className="container">
                                <div className="hero-style3">
                                    ...
                                    <p className="hero-text" data-ani="slideinleft" data-ani-delay="0.4s">
                                        BSTours.lk is your trusted travel partner specializing in Buddhist pilgrimage tours to India (Dambadiwa), Thailand, Bangkok, and Sri Lanka.
                                    </p>
                        ...
                        <div className="container">
                            <div className="hero-style3">
                                <h1 className="hero-title" data-ani="slideinleft" data-ani-delay="0.2s">
                                    Travel experience with BSTours.lk
                                </h1>
                                <p className="hero-text" data-ani="slideinleft" data-ani-delay="0.4s">
